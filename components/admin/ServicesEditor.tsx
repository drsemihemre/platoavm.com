...
export function ServicesEditor({ services: initial }: { services: Service[] }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <button onClick={add} className="w-full border-2 border-dashed border-stone-300 rounded-2xl p-4 text-stone-600 hover:border-orange-500 hover:text-orange-700 font-semibold">
        + Yeni Hizmet
      </button>
